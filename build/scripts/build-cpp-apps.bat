...
if exist "%wrapperApplicationSourceCode%" (
    ...
    call :compile_program "%wrapperApplicationSourceCode%" "-I../include %wrapperApplicationSourceCode% -o %wrapperApplicationSourceCodeIntoTheExecutable%" -mwindows
    if errorlevel 1 (
